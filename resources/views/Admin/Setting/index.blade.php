                        ...
                        <form action="{{ url('admin-dashboard/settingupdate')  }}" method="post">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="password" name="password" placeholder="Enter password if you want to change">
                                    </div>
                                    @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" id="confirm-password" name="confirmpassword" placeholder="Confirm your password">
                                    </div>
